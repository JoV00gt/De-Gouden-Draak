...
<div class="container w-3/4 py-3 mx-auto px-4">
    <h2 class="text-2xl font-bold mb-4">Maak nieuwe aanbieding</h2> <!-- TODO: Translation -->
    <form action="{{ route('deals.store') }}" method="POST">
        ...
        <div class="flex items-center justify-end">
            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Maak aanbieding aan</button><!-- TODO: Translation -->
        </div>
    </form>
</div>
</x-checkout-layout>